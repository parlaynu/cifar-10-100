...
../../train.py -w 2 -e 75 -b 64 --lr 0.00001 mobilenet_v3_large ~/Projects/datasets/cifar-10
../../train.py -w 2 -e 75 -b 64 --lr 0.00005 mobilenet_v3_large ~/Projects/datasets/cifar-10
../../train.py -w 2 -e 75 -b 64 --lr 0.0001 mobilenet_v3_large ~/Projects/datasets/cifar-10
