...
def _tweak_mobilenet(model, num_classes, use_gpu):
...
def _tweak_resnet(model, num_classes, use_gpu):
...
def resnet18(num_classes, *, pretrained=True, use_gpu=False):
    weights = None
    if pretrained:
        weights = torchvision.models.ResNet18_Weights.IMAGENET1K_V1

    model = torchvision.models.resnet18(weights=weights)
    model = _tweak_resnet(model, num_classes, use_gpu)
...
def resnet34(num_classes, *, pretrained=True, use_gpu=False):
    weights = None
    if pretrained:
...
def resnet50(num_classes, *, pretrained=True, use_gpu=False):
    weights = None
    if pretrained:
...
def resnet101(num_classes, *, pretrained=True, use_gpu=False):
    weights = None
    if pretrained:
...
def resnet152(num_classes, *, pretrained=True, use_gpu=False):
    weights = None
    if pretrained:
