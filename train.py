...
def main():
    ...
    parser.add_argument('--lr', help='learning rate optimizer', type=float, default=0.0001)
    parser.add_argument('--wd', help='weight decay for optimizer', type=float, default=0.01)
